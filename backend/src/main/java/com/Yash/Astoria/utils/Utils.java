package com.Yash.Astoria.utils;
...
public class Utils {
    ...
    //just a method to create a random bookingConfirmationCode
    public static String generateRandomConfirmationCode(int length){

        StringBuilder stringBuilder = new StringBuilder();
        for(int i = 0;i < length;i++){

            //picking up random character at random index and then appending into StringBuilder
    ...
    public static UserDTO mapUserEntityToUserDTO(User user){
        ...
        //picking up data from user entity and setting in UserDTO using setters
