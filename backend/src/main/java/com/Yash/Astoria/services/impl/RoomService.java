...
import com.Yash.Astoria.dto.RoomDTO;
...
import com.Yash.Astoria.services.AwsS3Service;
...
public class RoomService implements IRoomService {
    ...
    public Response getAllRooms() {
        ...
        try{
            ...
            response.setStatusCode(500);
            response.setMessage("Error retrieving all the Rooms");
        }
    ...
    public Response deleteRoom(Long roomId) {
        ...
        try {
            ...
            response.setStatusCode(500);
            response.setMessage("Error while deleting a Room");
        }
    ...
    public Response getRoomById(Long roomId) {
        ...
        try {
            ...
            response.setStatusCode(500);
            response.setMessage("Error while retrieving a room by Id");
        }
    ...
    public Response getAvailableRoomsByDateAndType(LocalDate checkInDate, LocalDate checkOutDate, String roomType) {
        ...
        try {
            ...
            response.setStatusCode(500);
            response.setMessage("Error while retrieving available Rooms using Date and Type");
        }
    ...
    public Response getAllAvailableRooms() {
        ...
        try {
            ...
            response.setStatusCode(500);
            response.setMessage("Error while retrieving all available Rooms");
        }
